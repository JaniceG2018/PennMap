...
public interface IQuadTree {
	 ...
	 * @return true if the new Location is inserted, and false otherwise
	 */
	 ...
	 * @return a list of Locations of the given type within range
	 */
	public List<Location> search(String type, Range range);
	
	/**
	 * Calculate the smallest possible Range that contains all given Locations. Also re-initialize the root of the QuadTree
